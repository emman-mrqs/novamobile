...
<head>
    ...
    <title>Nova Mobile Accessories</title>
...
<body>
      ...
      <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="./phone.php">Phones</a>
                  </li>
                  <li class="nav-item active">
                      <a class="nav-link active">Accessories</a>
                  </li>
              </ul>
          </div>
      </div>
 ...
 <div class="container mt-5">
        <div class="row justify-content-center">
            <?php
            // Fetch only products of type 'accessories' from the database
            $stmt = $conn->prepare("SELECT * FROM products WHERE type = :type");
            $stmt->execute(['type' => 'accessories']);
